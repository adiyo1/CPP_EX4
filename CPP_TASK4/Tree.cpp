...
// // template<typename T>
// // Tree<T>::Tree(size_t max_children) : root(nullptr), max_children(max_children) {}
...
// // template<typename T>
// // void Tree<T>::prsize_t() {
// //     prsize_t_structure();
// // }

// // template<typename T>
// // void Tree<T>::prsize_t_structure() {
// //     if (!root) return;
...
// //     size_t depth = levels.size();
// //     size_t max_width = pow(2, depth) * 2;

// //     for (size_t i = 0; i < depth; ++i) {
// //         size_t node_count = levels[i].size();
// //         size_t spacing = max_width / (node_count + 1);
